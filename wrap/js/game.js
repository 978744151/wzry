    ...
    var heartbeattime = 19;//初始时间game_timer_bg时间
    var heartstoptime = 5;//真正game_timer_bg的时间
    var timeover = 0;
    ...
    //MAIN
    function heartbeat(){
        var tureBeatTime = heartbeattime + heartstoptime;//24
